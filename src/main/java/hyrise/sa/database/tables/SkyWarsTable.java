...
public class SkyWarsTable extends DataTable {
  ...
  public Map<String, DataContainer> getDefaultValues() {
    ...
    defaultValues.put("exp", new DataContainer(0L));
