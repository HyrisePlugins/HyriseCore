...
import hyrise.sa.libraries.npclib.api.event.*;
import hyrise.sa.libraries.npclib.npc.skin.SkinnableEntity;
import hyrise.sa.libraries.npclib.trait.CurrentLocation;
import hyrise.sa.libraries.npclib.trait.NPCTrait;
...
import hyrise.sa.libraries.npclib.api.event.*;
import hyrise.sa.libraries.npclib.api.metadata.MetadataStore;
import hyrise.sa.libraries.npclib.api.metadata.SimpleMetadataStore;
