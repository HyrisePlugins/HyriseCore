package hyrise.sa.nms.v1_8_R3;

import com.google.common.base.Preconditions;
import com.mojang.authlib.GameProfile;
import com.mojang.authlib.properties.Property;
import hyrise.sa.nms.v1_8_R3.utils.PlayerlistTrackerEntry;
import hyrise.sa.nms.v1_8_R3.utils.UUIDMetadataStore;
...
import hyrise.sa.libraries.npclib.api.npc.NPCAnimation;
import hyrise.sa.libraries.npclib.npc.EntityControllers;
import hyrise.sa.libraries.npclib.npc.ai.NPCHolder;
import hyrise.sa.libraries.npclib.npc.skin.SkinnableEntity;
import hyrise.sa.nms.interfaces.INMS;
import hyrise.sa.nms.interfaces.entity.IArmorStand;
import hyrise.sa.nms.interfaces.entity.IItem;
import hyrise.sa.nms.interfaces.entity.ISlime;
import hyrise.sa.nms.v1_8_R3.entity.EntityItem;
import hyrise.sa.nms.v1_8_R3.entity.EntityNPCPlayer;
import hyrise.sa.nms.v1_8_R3.entity.EntityStand;
import hyrise.sa.nms.v1_8_R3.entity.HumanController;
import hyrise.sa.reflection.Accessors;
import hyrise.sa.reflection.acessors.FieldAccessor;
import hyrise.sa.utils.Utils;
...
public class NMS1_8R3 implements INMS {
  ...
  public NMS1_8R3() {
    ...
    CLASS_TO_ID.get(null).put(hyrise.sa.nms.v1_8_R3.entity.EntityArmorStand.class, 30);
    CLASS_TO_NAME.get(null).put(hyrise.sa.nms.v1_8_R3.entity.EntityArmorStand.class, "kCore-ArmorStand");
    CLASS_TO_ID.get(null).put(hyrise.sa.nms.v1_8_R3.entity.EntitySlime.class, 55);
    CLASS_TO_NAME.get(null).put(hyrise.sa.nms.v1_8_R3.entity.EntitySlime.class, "kCore-Slime");
  ...
  public IArmorStand createArmorStand(Location location, String name, HologramLine line) {
    IArmorStand armor = line == null ? new EntityStand(location) : new hyrise.sa.nms.v1_8_R3.entity.EntityArmorStand(((CraftWorld) location.getWorld()).getHandle(), line);
  ...
  public ISlime createSlime(Location location, HologramLine line) {
    hyrise.sa.nms.v1_8_R3.entity.EntitySlime slime = new hyrise.sa.nms.v1_8_R3.entity.EntitySlime(((CraftWorld) location.getWorld()).getHandle(), line);
  ...
  public Hologram getHologram(Entity entity) {
    ...
    HologramLine e = null;
    if (en instanceof hyrise.sa.nms.v1_8_R3.entity.EntityArmorStand) {
      e = ((hyrise.sa.nms.v1_8_R3.entity.EntityArmorStand) en).getLine();
    } else if (en instanceof hyrise.sa.nms.v1_8_R3.entity.EntitySlime) {
      e = ((hyrise.sa.nms.v1_8_R3.entity.EntitySlime) en).getLine();
