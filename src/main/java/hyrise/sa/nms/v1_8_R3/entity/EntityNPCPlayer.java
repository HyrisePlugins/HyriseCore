package hyrise.sa.nms.v1_8_R3.entity;
...
import hyrise.sa.libraries.npclib.npc.skin.Skin;
import hyrise.sa.libraries.npclib.npc.skin.SkinPacketTracker;
import hyrise.sa.libraries.npclib.npc.skin.SkinnableEntity;
import hyrise.sa.nms.NMS;
import hyrise.sa.nms.v1_8_R3.network.EmptyNetHandler;
import hyrise.sa.nms.v1_8_R3.utils.PlayerNavigation;
import hyrise.sa.nms.v1_8_R3.utils.controllers.PlayerControllerJump;
import hyrise.sa.nms.v1_8_R3.utils.controllers.PlayerControllerLook;
import hyrise.sa.nms.v1_8_R3.utils.controllers.PlayerControllerMove;
...
public class EntityNPCPlayer extends EntityPlayer implements NPCHolder, SkinnableEntity {
  ...
  private final hyrise.sa.libraries.npclib.api.npc.NPC npc;
  ...
  public EntityNPCPlayer(MinecraftServer server, WorldServer world, GameProfile profile, PlayerInteractManager manager, hyrise.sa.libraries.npclib.api.npc.NPC npc) {
  ...
  protected void a(double d0, boolean flag, Block block, BlockPosition blockposition) {
    if (npc == null || !npc.data().get(hyrise.sa.libraries.npclib.api.npc.NPC.FLYABLE, false)) {
  ...
  public void t_() {
    ...
    if (!navigating && npc.data().get(hyrise.sa.libraries.npclib.api.npc.NPC.GRAVITY, false) && getBukkitEntity() != null && Utils.isLoaded(getBukkitEntity().getLocation())) {
      g(0, 0);
    }
  ...
  @Override
  public hyrise.sa.libraries.npclib.api.npc.NPC getNPC() {
    return npc;
  }
