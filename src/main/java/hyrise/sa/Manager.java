...
import hyrise.sa.libraries.profile.Mojang;
import hyrise.sa.player.fake.FakeManager;
import hyrise.sa.player.role.Role;
import hyrise.sa.reflection.acessors.MethodAccessor;
...
public class Manager {
  ...
  static {
    try {
      ...
      Class<?> bungeeMain = Class.forName("hyrise.sa.bungee.Bungee");
      ...
      try {
        ...
        Class<?> fakeManager = Class.forName("hyrise.sa.player.fake.FakeManager");
        GET_NAME = Accessors.getMethod(player, "getName");
        GET_PLAYER = Accessors.getMethod(Class.forName("hyrise.sa.player.Profile"), "findCached", String.class);
